...
function NewRecipiePost(P){
  ...
  const handleUpload = () =>{
    if(image && name && shortDescription && description && ingredients && method){
      P.firebase.recipePost({
        name: name,
...
export default withFirebaseHOC(NewRecipiePost);